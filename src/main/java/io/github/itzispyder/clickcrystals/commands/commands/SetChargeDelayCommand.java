...
public class SetChargeDelayCommand extends Command {
    public SetChargeDelayCommand() {
        super("setchargedelay","§7Sets the delays for AutoTotem.","/scd [int short delay] [int long delay]", "scd");
    }
