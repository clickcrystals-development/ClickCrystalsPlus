...
public class BlockDelayRemover extends Module implements Listener {
    ...
    public BlockDelayRemover() {
        super("RemBreakDelay", Categories.OPTIMIZATION,"Removes the delay between breaking a block and starting to break the next block. (Some AntiCheats don't like this module)");
    }
